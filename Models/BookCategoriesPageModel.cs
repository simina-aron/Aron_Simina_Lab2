...
namespace Aron_Simina_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Aron_Simina_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Aron_Simina_Lab2Context context,
